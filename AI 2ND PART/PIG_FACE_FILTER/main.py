...
nose_img = cv2.imread('brad.jpgq')
cap.set(3, 640) #da width
...
while True:
  ...
  if results.multi_face_landmarks:
    for face_landmarks in results.multi_face_landmarks:
      ...
      # mpDraw.draw_landmarks(image=frame,landmark_list=face_landmarks, connections=mpFaceMesh.FACEMESH_CONTOURS,
      # landmark_drawing_spec=None,
      # connection_drawing_spec=mpDrawingStyles.
      ...
      nose_mask = cv2.threshold(pig_nose_gray, 25, 255, cv2.THRESH_BINARY_INV)[1]
